...
watch(
  () => histroyState.historyListVisible,
...
<template>
  <el-card shadow="hover">
    ...
    >
      ...
      <div class="flex-item">
        <div
          @click="histroyState.historyListVisible = true"
          style="color: rgb(207, 15, 124); cursor: pointer; font-weight: 700"
        >
          Histroy
        </div>
      </div>
  ...
  >
    <div style="display: flex">
      <div
        ...
        "
      >
        <div style="color: aliceblue">SimpMainLogServer :: created By leeks</div>
        <div
          style="color: aliceblue; margin: 2px; white-space: pre"
          v-html="histroyState.logger"
        ></div>
      </div>
      <div style="flex: 3">
        <el-form :model="histroyState" label-width="auto" style="max-width: 600px">
          ...
          <el-form-item label="Submit">
            <div style="display: flex; align-items: center; justify-content: center">
              <el-button type="primary" @click="histroyState.historyListVisible = false"
                >Close</el-button
              >
  ...
  <shellDialog :shell-visible="shellVisible" @close-dialog="shellVisible = false">
  </shellDialog>
</template>
